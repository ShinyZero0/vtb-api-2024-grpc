...
func (c *chatClient) Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamRequest, StreamResponse], error) {
...
type Chat_StreamClient = grpc.BidiStreamingClient[StreamRequest, StreamResponse]
...
func (UnimplementedChatServer) Stream(grpc.BidiStreamingServer[StreamRequest, StreamResponse]) error {
...
func _Chat_Stream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChatServer).Stream(&grpc.GenericServerStream[StreamRequest, StreamResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Chat_StreamServer = grpc.BidiStreamingServer[StreamRequest, StreamResponse]
